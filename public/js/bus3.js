...
function loadMap(interactive) {
	...
	startPos = new google.maps.LatLng(37.95543670654296875,-121.28559112548828125);
...
function getPaths() {
	...
	var lat = 37.95543670654296875;
	var lon = -121.28559112548828125;
	var fd = "09:30:31";
	var distance = 0.1242742384474668;
	var time = 10;
	
	$.ajax({
		type : 'GET',
		url : '/z/segments?lat=' + lat + '&lon=' + lon + '&datetime=' + fd + '&distance=' + distance + '&time=' + time,
		dataType : 'json',
